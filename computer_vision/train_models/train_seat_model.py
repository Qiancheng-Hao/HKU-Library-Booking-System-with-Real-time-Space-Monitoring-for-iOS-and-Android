...
PROJECT_DIR = os.path.join(os.path.dirname(current_path), "fyp", "chair_and_sofa")
DATASET_ROOT = os.path.join(PROJECT_DIR, "dataset_seat")
DATA_YAML = os.path.join(DATASET_ROOT, "data.yaml")
CHECKPOINT_NAME = "version_1"
...
if __name__ == "__main__":
    ...
    if resume_path:
        ...
        results = model.train(
            ...
            # Data Augmentation (Optimized for chair/sofa detection)
            cache=False,
            augment=True,
            ...
            flipud=0.0,              # Keep 0 for furniture detection
